...
congruent_data <- subset(descriptive, typeoftrial == "congruent_iat")
incongruent_data <- subset(descriptive, typeoftrial == "incongruent_iat")
...
# outlier 1: under 75% attention accuracy
```{r}
subject_attention_accuracy_filter <- subject_attention_accuracy %>%
  filter(mean_accuracy >= 0.75)
```
# outlier 2: see above in chunk 3
